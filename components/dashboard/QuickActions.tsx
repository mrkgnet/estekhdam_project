...
const actions = [
  { title: "شروع آزمون جدید", desc: "از بین آزمون‌ها انتخاب کن", href: "/tests", icon: FileText },
  { title: "خرید اشتراک", desc: "فعال‌سازی امکانات کامل", href: "/pricing", icon: CreditCard },
  { title: "مطالعه درس‌ها", desc: "رفتن به درس‌ها و دوره‌ها", href: "/courses", icon: BookOpen },
  { title: "پشتیبانی", desc: "سوال داری؟ پیام بده", href: "/support", icon: Headphones },
];
