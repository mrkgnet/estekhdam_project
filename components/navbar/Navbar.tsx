...
export default function NavbarUser() {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center w-full px-4 py-4 bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-sm sm:px-6">
      {/* ================= سمت راست: دکمه منو ================= */}
      ...
      <div className="flex items-center gap-2 sm:gap-4 mx-2">
        ...
        <div className="flex items-center gap-1 border-l border-gray-200 ">
          <Link
            href={"/"}
            className="flex items-center gap-2 px-2 py-2 font-medium text-gray-600 transition-colors duration-200 rounded-xl hover:bg-gray-100 hover:text-gray-900"
          >
          ...
          <div className="relative bg-slate-100 rounded-md">
            {/* بج آبی */}
            <span className="absolute -top-3 left-0 px-2 py-0.5 text-[10px] font-bold text-white bg-blue-500 rounded-full shadow-sm">
              جدید
            </span>
