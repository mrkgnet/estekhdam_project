...
export default function NavbarUser() {
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center w-full px-4 py-2 bg-white dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-200 dark:border-slate-800 shadow-sm sm:px-6 transition-colors duration-300">
