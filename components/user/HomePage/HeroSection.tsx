        ...
        <section className="relative min-h-[600px] overflow-hidden">
            ...
            <div className="relative z-10 mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
                ...
                <div className="mx-auto max-w-5xl">
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {stats.map((stat, index) => (
                            <article
                                key={index}
                                className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/95 p-6 shadow-xl backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl"
                            >
                                {/* آیکون و شماره */}
                                <div className="mb-4 flex items-center justify-between">
                                    <div className={`rounded-xl bg-${stat.color}-50 p-3 text-${stat.color}-600 transition-transform duration-300 group-hover:scale-110`}>
                                        {stat.icon}
                                    </div>
                ...
                <div className="mt-12 text-center">
                    <button className="inline-flex items-center gap-2 rounded-full bg-teal-500 px-8 py-4 text-lg font-bold text-white shadow-lg transition-all duration-300 hover:bg-teal-600 hover:shadow-xl hover:scale-105">
                        شروع آزمون رایگان
