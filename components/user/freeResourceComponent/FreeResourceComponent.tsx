                ...
                <div className=" bg-gradient-to-l from-[#3b5998] to-[#5577ba] flex flex-col rounded-t-lg shadow-lg">
                    <div className="flex items-center justify-between gap-3 px-4 py-3">
                        ...
                        <Link
                            ...
                            target="_blank"
                            className="text-14  text-white hover:text-white transition-colors whitespace-nowrap border-3 border-dashed  border-white hover:border-white/50 rounded-full px-2.5 py-0.5"
                        >
                            مشاهده همه
                        </Link>
                    </div>
