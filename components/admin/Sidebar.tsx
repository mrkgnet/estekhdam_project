...
export default function Sidebar() {
    ...
    if (level === 1 && tabId) {
      if (
        ...
        if (
          ...
          const clickedTab = tabsDataAdminPanel.find(
            (t) => t.id === tabId
          );
  ...
  // --------------------------------------------------
  // Active menu calculations
  // --------------------------------------------------
  const activeTab = tabsDataAdminPanel.find(
    (t) => t.id === activeTabId
  );
                ...
                >
                  <div
                    className={`
                      ...
                      ${
                        isActive
                          ? "md:bg-blue-50 text-blue-700 font-bold"
            ...
            {hasLevel2 && activeTab && (
              <>
                <Link
                  href={activeTab.url}
                  onClick={close}
                  className="text-blue-600 mb-4 flex items-center gap-1 font-bold"
                >
                  {activeTab.title}
