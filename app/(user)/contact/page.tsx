        ...
        <div className="min-h-screen bg-[#F8FAFC] py-10 px-4 sm:px-6">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-7 bg-white rounded-3xl shadow-sm border border-slate-100 p-6 sm:p-10">
                        <div className="mb-8">
                            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-indigo-50 text-indigo-600 mb-4">
                                <MessageSquare className="w-7 h-7" />
                            </div>
                            <h1 className="text-2xl font-black text-slate-800 mb-3">ثبت تیکت و پیام</h1>
                        ...
                        <form ref={formRef} action={formAction} className="space-y-6">
                            <div className="space-y-2.5">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-4 pr-12 py-3.5 bg-slate-50/50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all placeholder:text-slate-400"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2.5">
                                ...
                                <textarea
                                    ...
                                    className="w-full p-4 bg-slate-50/50 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all placeholder:text-slate-400 resize-none leading-relaxed"
                                />
                            </div>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 h-14 rounded-2xl bg-blue-800 text-white  text-[15px] hover:bg-slate-800 transition-all shadow-xl shadow-slate-900/20 disabled:opacity-70 disabled:cursor-not-allowed group cursor-pointer"
                            >
                                {isPending || isLoading ? (
                                    ...
                                    <>
                                        {isLoggedIn ? (
                                            ...
                                            <span>ابتدا وارد حساب کاربری شوید</span>
                                        )}
                                    </>
                                )}
                            </button>
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 sm:p-8">
                            <h3 className="text-lg  text-slate-800 mb-2">پاسخگویی سریع‌تر</h3>
                            ...
                            <div className="space-y-3.5">
                                ...
                                >
                                    ...
                                    <div className="flex flex-col">
                                        <span className=" text-[15px]">پشتیبانی در تلگرام</span>
                                        <span className="text-xs opacity-80 mt-0.5">پاسخگویی سریع (پبشنهاد ما)</span>
                                    </div>
                                </Link>
                                ...
                                >
                                    ...
                                    <div className="flex flex-col">
                                        <span className=" text-[15px]">پشتیبانی در ایتا</span>
                                        <span className="text-xs opacity-80 mt-0.5">پاسخگویی سریع </span>
                                    </div>
                                </Link>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-900 rounded-3xl shadow-lg border border-slate-800 p-6 sm:p-8 text-white relative overflow-hidden">
                            ...
                            <h3 className="text-lg  mb-6 relative z-10">اطلاعات تماس</h3>
                            ...
                            <div className="space-y-5 relative z-10">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-sm text-slate-400">تلفن پشتیبانی</span>
                                        <span className=" text-[15px] mt-0.5 dir-ltr text-right">021 - 1234 5678</span>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-xl bg-white/10 flex items-center justify-center">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-sm text-slate-400">ایمیل سازمانی</span>
                                        <span className=" text-[15px] mt-0.5 dir-ltr text-right">info@yourwebsite.com</span>
                                    </div>
                                </div>
                            </div>
                        </div>
