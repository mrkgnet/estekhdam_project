...
// اگر اکشن‌های منابع رایگان جدا هستند، آدرس‌های زیر را به اکشن‌های جدید تغییر دهید
...
export default function FreeCategoryManager({ getDataCat }: { getDataCat: any }) {
    ...
    useEffect(() => {
        if (addState?.success) {
            ...
            setAddExternalUrl("");
            clearAddImage();
            toast.success(addState?.message || "دسته منابع رایگان با موفقیت ثبت شد");
        }
    }, [addState]);
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto text-xs md:text-sm" dir="rtl">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-base font-bold text-gray-800">مدیریت دسته‌بندی منابع رایگان</h1>
                <button
                ...
                <table className="w-full text-right border-collapse">
                    <thead className="bg-gray-50 text-gray-600">
                        <tr>
                            ...
                            <th className="p-4 border-b">نام دسته رایگان</th>
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {categories.length > 0 ? (
                                ...
                                <tr key={cat.id} className="hover:bg-gray-50/50 transition-colors group">
                                    ...
                                    <td className="p-4">
                                        {cat.parentId ? (
                                            ...
                                            <span className="text-emerald-600 bg-emerald-50 px-2 py-1 rounded text-[11px] font-semibold">دسته اصلی منابع</span>
                                        )}
                                    </td>
                            ...
                            <tr>
                                <td colSpan={6} className="p-12 text-center text-gray-400">لیست دسته‌بندی منابع رایگان خالی است.</td>
                            </tr>
                        )}
                    </tbody>
                </table>
                    ...
                    <div className="bg-white p-6 rounded w-full max-w-md shadow-2xl overflow-y-auto max-h-[90vh]">
                        ...
                        <form ref={addFormRef} action={addFormAction} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" required name="catName" value={addCatName} onChange={handleAddNameChange} className="w-full border border-gray-200 p-2.5 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none transition-all" placeholder="مثلاً: منابع رایگان بانک‌ها" />
                            </div>
